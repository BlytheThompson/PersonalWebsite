!(function (e, n) {
    ...
    return (function (e) {
      ...
      function (e, n, t) {
        ...
        function a(e, n) {
          return (
            null == e && (e = 0),
            null == n && (n = 1),
            Math.floor(e + Math.random() * (n - e + 1))
          );
        }
      ...
      function (e, n, t) {
        ...
        (r.register = (e, n) => (r[e] = (e) => new n(e))), (r.version = "0.5.2");
        var a = function () {
          return (
        ...
        (r.VantaBase = class {
          constructor(e = {}) {
            ...
            if (
              ...
              (this.options = Object(i.c)({}, this.defaultOptions)),
              e instanceof HTMLElement || "string" == typeof e
                ? Object(i.c)(this.options, { el: e })
              ...
              !(
                ...
                ((c = this.el), (this.el = Object(i.e)(c)), this.el)
              )
            )
              return void a("Cannot find element", c);
            for (u = 0; u < this.el.children.length; u++)
              (n = this.el.children[u]),
                "static" === getComputedStyle(n).position &&
                  (n.style.position = "relative"),
                "auto" === getComputedStyle(n).zIndex && (n.style.zIndex = 1);
            "static" === getComputedStyle(this.el).position &&
              ...
              (this.uniforms = {
                ...
                u_resolution: { type: "v2", value: new s.Vector2(1, 1) },
                u_mouse: { type: "v2", value: new s.Vector2(0, 0) },
              });
            try {
              this.init();
            } catch (e) {
          ...
          windowMouseMoveWrapper(e) {
            ...
            t >= 0 &&
              ...
              ((this.mouseX = t),
              (this.mouseY = i),
              this.options.mouseEase || this.triggerMouseMove(t, i));
          }
          windowTouchWrapper(e) {
            if (1 === e.touches.length) {
              const n = this.renderer.domElement.getBoundingClientRect(),
                t = e.touches[0].clientX - n.left,
                i = e.touches[0].clientY - n.top;
              t >= 0 &&
                i >= 0 &&
                t <= n.width &&
                i <= n.height &&
          ...
          triggerMouseMove(e, n) {
            this.uniforms &&
              ...
              (this.uniforms.u_mouse.value.y = n / this.scale));
          ...
          setSize() {
            this.scale || (this.scale = 1),
              Object(i.d)() && this.options.scaleMobile
          ...
          resize() {
            ...
            this.setSize(),
              ...
              null != (n = this.camera) &&
                "function" == typeof n.updateProjectionMatrix &&
          ...
          isOnscreen() {
            const e = this.el.offsetHeight,
              ...
              i = n.top + t;
            return i - window.innerHeight <= t && t <= i + e;
          }
          animationLoop() {
            return (
              this.t || (this.t = 0),
        ...
        class s extends i.b {
          ...
          initBasicShader(e = this.fragmentShader, n = this.vertexShader) {
            ...
            return (
              ...
              (i = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), t)),
              this.scene.add(i),
            ...
            for (e in ((n = {}), (t = this.options)))
              (i = t[e]),
                -1 !== e.toLowerCase().indexOf("color")
                  ? (n[e] = { type: "v3", value: new THREE.Color(i).toVector() })
                  : "number" == typeof i && (n[e] = { type: "f", value: i });
      ...
      function (e, n, t) {
        ...
        var i = t(2);
        class o extends i.b {}
        (n.default = i.a.register("CLOUDS", o)),
